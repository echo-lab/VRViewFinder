...
public class ExampleOSCMessageSender : MonoBehaviour {
    ...
    public string externalIP = "192.168.1.198"; // the IP of the machine to which you want to send messages
    public int externalPort = 1234; // the port on which the receiving machine will be listening for messages
