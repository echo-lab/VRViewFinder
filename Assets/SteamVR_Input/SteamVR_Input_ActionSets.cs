...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_VRViewFinderAction p_VRViewFinderAction;
        ...
        public static SteamVR_Input_ActionSet_VRViewFinderAction VRViewFinderAction
        {
            get
            {
                return SteamVR_Actions.p_VRViewFinderAction.GetCopy<SteamVR_Input_ActionSet_VRViewFinderAction>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_VRViewFinderAction = ((SteamVR_Input_ActionSet_VRViewFinderAction)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_VRViewFinderAction>("/actions/VRViewFinderAction")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.VRViewFinderAction};
        }
    }
}
